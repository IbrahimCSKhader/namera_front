...
const milestones = [
  ...
  { year: 'اليوم', title: 'تجربة مخصصة', text: 'كل قطعة تمر بمرحلة اختيار الألوان، الصور، والأسماء حتى تصل كهدية جاهزة ومميزة.' },
];
      ...
      <section className="about-story">
        <div>
          ...
          <p>
            ...
            لذلك نعامل كل طلب كقطعة واحدة لا تتكرر، ونصنعها يدويًا بخطوات هادئة تبدأ من فهم الفكرة وتنتهي بقطعة تليق بها.
          </p>
        </div>
